...
const FeatureToggle = ({
  ...
  const StartRecordFunction = (_) => {
    if (startRecord) {
      ...
      mymap.on("click", MyMapClickFunction);
      alert(
        "Saved latitude and longitude to local storage and console.\nCheck Recording"
      );
  ...
  return (
    <div className="features icon-hide" ref={featureRef}>
      <i
        ...
        ref={AlertIcon}
        className="fa fa-bullhorn DisplayNone feature"
        aria-hidden="true"
      ></i>
      <i
        onClick={StartRecordFunction}
        ref={RecordIcon}
        className="fa fa-bullseye DisplayNone feature"
        aria-hidden="true"
      ></i>
      <i
        onClick={CloseFeatures}
        ref={CloseIcon}
        className="fa fa-times DisplayNone feature"
        aria-hidden="true"
      ></i>
      <i
